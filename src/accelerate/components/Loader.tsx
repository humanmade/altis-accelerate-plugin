...
export default function Loader( props: Props ) {
	const classes = [
		'Loader',
		props.isLight && 'Loader--light',
		props.isGiant && 'Loader--giant',
	];
	return (
		<svg
