...
namespace Altis\Accelerate\Broadcast;
...
function broadcast_allowed_block_types( $allowed_block_types, WP_Block_Editor_Context $editor_context ) {
	if ( ! $editor_context->post || $editor_context->post->post_type !== POST_TYPE ) {
 ...
 *
 * @example `echo Altis\Accelerate\Broadcast\render( $broadcast_id = 120, $client_id = 'footer-hero-broadcast' );`
 *
