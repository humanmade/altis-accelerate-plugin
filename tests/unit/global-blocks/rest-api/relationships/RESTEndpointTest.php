...
namespace Altis\Tests\Unit\GlobalBlocks\REST_API\Relationships;

use Altis\Tests\Unit\TestCase;
use Altis\GlobalBlocks\REST_API\Relationships\REST_Endpoint as Testee;
...
class RESTEndpointTest extends TestCase {
	...
	public function test_get_items_valid() {
		...
		Functions\expect( 'rest_url' )
			->with( 'altis-global-blocks/v1/relationships' )
			->once();
