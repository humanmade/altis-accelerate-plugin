...
use Altis\GlobalBlocks\Connections as Testee;
use const Altis\GlobalBlocks\BLOCK_POST_TYPE;
...
class ConnectionsTest extends TestCase {
	...
	public function test_bootstrap() {
		Actions\expectAdded( 'init' )
			->with( 'Altis\GlobalBlocks\Connections\register_relationship_taxonomy' );

		Actions\expectAdded( 'wp_insert_post' )
			->with( 'Altis\GlobalBlocks\Connections\maybe_create_shadow_term', 10, 2 );

		Actions\expectAdded( 'before_delete_post' )
			->with( 'Altis\GlobalBlocks\Connections\delete_shadow_term' );

		Actions\expectAdded( 'post_updated' )
			->with( 'Altis\GlobalBlocks\Connections\synchronize_associated_terms', 10, 3 );

		Filters\expectAdded( 'manage_wp_block_posts_columns' )
			->with( 'Altis\GlobalBlocks\Connections\manage_wp_block_posts_columns' );

		Actions\expectAdded( 'manage_wp_block_posts_custom_column' )
			->with( 'Altis\GlobalBlocks\Connections\usage_column_output', 10, 2 );
